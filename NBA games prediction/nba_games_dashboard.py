...
games = gamefinder.get_data_frames()[0]  # to display team names in the dropdown

# get the team names
team_names = games['TEAM_NAME'].unique()

# to sort the team names in alphabetical order
team_names.sort()

# create a list of dictionaries for the dropdown option, based on team names
...
app.layout = html.Div([
    ...
    dcc.Dropdown(
        ...
        value=team_names[0]  # default value
    ),
    html.H2("Away Team"),
    dcc.Dropdown(
        id='away_team',
